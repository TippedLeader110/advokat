				...
				<div class="row">
					<div class="col-6 col-md-12">
						...
						<div class="form-group">
							<input type="text" hidden name="id_p" value="<?php echo $value->id_p ?>">
...
<script type="text/javascript">
	...
	$('#return').click(function(event) {
		...
		$('#contentModal').load('<?php echo base_url('admin/select_kelolahPengacara?id='); echo $value->id_p; ?>&status=<?php echo $value->status ?>', function(){
			$('#loading').hide();
